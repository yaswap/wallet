      ...
      <div class="wrapper_top">
        ...
        <div class="permission-screen_tx">
          ...
          <div v-if="!scanningChangeOutput">
            ...
            >
              <div>{{ fromOutputScript(output.script) }}</div>
              <div class="row">
                ...
                <div class="col text-right">
                  <span
                    ...
                    v-if="externalAddresses.includes(fromOutputScript(output.script))"
                    >My Wallet</span
                  >
                </div>
              </div>
...
import { Transaction as TransactionYacoinJs, address as AddressYacoinJs } from 'yacoinjs-lib'
...
export default {
  ...
  computed: {
    ...
    // },
    outputs() {
      return this.transaction.outs.filter((output, i) => i !== this.changeOutputIndex)
    },
    outputsValue() {
      return this.transaction.outs.reduce((total, vout) => total + vout.value, 0)
    },
    request() {
      return {
        ...this.$route.query,
