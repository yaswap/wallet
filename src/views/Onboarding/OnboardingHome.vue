    ...
    <div class="onboading-home_tnc">
      ...
      >
        <p class="c7" id="h.gjdgxs">
          <span class="c14 c3">
            THIS IS THE BETA VERSION OF THE YASWAP PLATFORM WHICH IS STILL BEING ACTIVELY DEVELOPED.
            YOU ACKNOWLEDGE THE INFORMATION AVAILABLE IS NOT INTENDED TO BE RELIED ON OR USED IN A
            PRODUCTION ENVIRONMENT. YOU ACKNOWLEDGE AND ACCEPT THAT THE SITE OR SERVICES (A) MAY
            CONTAIN BUGS, ERRORS, AND DEFECTS, (B) MAY FUNCTION IMPROPERLY OR BE SUBJECT TO PERIODS
            OF DOWNTIME AN UNAVAILABILITY, (C) MAY RESULT IN TOTAL OR PARTIAL LOSS OR CORRUPTION OF
            DATA USED IN THE SITE, AND (D) MAY BE MODIFIED AT ANY TIME, INCLUDING THROUGH THE
            RELEASE OF SUBSEQUENT VERSIONS, ALL WITH OR WITHOUT NOTICE. THE ALPHA PLATFORM IS
            AVAILABLE ON AN “AS IS” AND “AS AVAILABLE” BASIS FOR THE SOLE PURPOSE OF COLLECTING
            FEEDBACK ON QUALITY, USABILITY, PERFORMANCE AND ANY DEFECTS. THANK YOU FOR YOUR SUPPORT
        ...
        <p class="c7">
          ...
          <span>
            ”). Yaswap is a client-based platform that would enable users to swap consumer tokens on
            a peer-to-peer basis without an intermediary. These terms of use (“
          </span>
